function Footer() {
  return (
    ...
    '>
        <div className=' max-w-[108rem] w-full flex justify-start items-center gap-[4rem] footer-res '>
            <div className="f-top w-full flex justify-start flex-col gap-[8rem] max-sm:gap-[4rem]">
