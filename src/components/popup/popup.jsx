...
function Popup() {
  return (
    <div className='popup absolute z-10 bottom-[50%] left-[50%] -translate-y-1/2 -translate-x-1/2 w-full flex items-center justify-center'>
        <div className=' p-[4.8rem_6rem_6rem_6rem] max-w-[60%]
