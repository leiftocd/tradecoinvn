  ...
  return (
    ...
    '>
        ...
        <div className='btn-footer flex items-center w-full justify-center py-[6rem]'>
                    <Link to={`/redirect?link=${encodeURIComponent('https://t.me/TCVN_Support')}`} className= ' rounded-[10px] bg-[rgba(28,28,28,0.19)] shadow-[inset_0px_17px_56.7px_-42px_rgba(255,254,254,0.32)] backdrop-blur-[38.85px] border-2 border-[#00E9EC] hover:bg-gradient-to-r from-[rgba(17,93,242,0.48)] to-[rgba(0,233,236,0.48)] cursor-pointer px-[4rem] py-[1.5rem] flex items-center gap-[1rem] max-lg:px-[1.6rem] max-lg:py-[1.2rem]'>
